...
var PROGRAM_CATALOG = [
  ...
  { code: 'Tue FF R 6',   value: 'Tuesday FF (Richmond) 6:00-7:45 PM',       label: 'Tuesday · Foundation Focus · Richmond · 6:00–7:45 PM',       price: '$295 GST Included', dates: '9 Tuesdays · Sep 15 – Nov 10 (ext. to Nov 24 if needed)',                                       column: 'Tue FF',         shortLabel: 'Tue FF R 6-745' },
  { code: 'Tue FF R 745', value: 'Tuesday FF (Richmond) 7:45-9:30 PM',       label: 'Tuesday · Foundation Focus · Richmond · 7:45–9:30 PM',       price: '$295 GST Included', dates: '9 Tuesdays · Sep 15 – Nov 10 (ext. to Nov 24 if needed)',                                       column: 'Tue FF',         shortLabel: 'Tue FF R 745-930' },
  { code: 'Tue FF B 6',   value: 'Tuesday FF (South Burnaby) 6:00-7:30 PM',  label: 'Tuesday · Foundation Focus · South Burnaby · 6:00–7:30 PM',  price: '$255 GST Included', dates: '9 Tuesdays · Sep 15 – Nov 10 (ext. to Nov 24 if needed)',                                       column: 'Tue FF',         shortLabel: 'Tue FF B 6-730' },
  { code: 'Tue FF B 730', value: 'Tuesday FF (South Burnaby) 7:30-9:00 PM',  label: 'Tuesday · Foundation Focus · South Burnaby · 7:30–9:00 PM',  price: '$255 GST Included', dates: '9 Tuesdays · Sep 15 – Nov 10 (ext. to Nov 24 if needed)',                                       column: 'Tue FF',         shortLabel: 'Tue FF B 730-9' },
